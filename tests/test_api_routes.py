...
EXPECTED_ROUTES = {
    ...
    ("/api/learnings/backfill/estimate", "GET"),
    ("/api/learnings/backfill/status", "GET"),
    ("/api/learnings/refresh", "POST"),
    ("/api/learnings/synthesize", "POST"),
    ("/api/learnings/{owner}/{repo}/refresh", "POST"),
    ("/api/learnings/{owner}/{repo}/synthesize", "POST"),
    ...
    ("/api/rules", "POST"),
    ("/api/rules", "PUT"),
    ("/api/rules/approve", "POST"),
    ("/api/rules/delete", "POST"),
    ("/api/rules/enabled", "PATCH"),
